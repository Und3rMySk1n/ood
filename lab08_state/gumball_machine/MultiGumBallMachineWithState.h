...
namespace multi_with_state
{
	...
	struct IGumballMachine
	{
		...
		virtual void EatOneQuarter() = 0;
		virtual void AddOneQuarter() = 0;
		virtual void EjectQuarters() = 0;
		virtual unsigned GetBallCount()const = 0;
		virtual int GetQuartersCount()const = 0;		
	...
	public:
		...
		void InsertQuarter() override
		{
			if (m_gumballMachine.GetQuartersCount() < 5)
			{
				...
				m_gumballMachine.AddOneQuarter();
			}
			else
			{
		...
		{
			std::cout << "You turned...\n";
			m_gumballMachine.EatOneQuarter();
...
Machine is %4%
			...
			return (fmt % m_count % (m_count != 1 ? "s" : "") % m_quarters % m_state->ToString()).str();
		}
	private:
		...
		int GetQuartersCount() const override
		{
			return m_quarters;
		}
		...
		virtual void EatOneQuarter() override
		{
			if (m_quarters != 0)
			{
				std::cout << "One quarter is paid...\n";
				--m_quarters;
			}
		}

		virtual void AddOneQuarter() override
		{
			if (m_quarters < 5)
			{
				std::cout << "One quarter is added...\n";
				++m_quarters;
			}
		}
